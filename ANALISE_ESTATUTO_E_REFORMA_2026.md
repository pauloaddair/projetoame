...
criado: "2026-09-15"
revisao: "2026-09-15"
assunto: "Análise integral do Estatuto vigente (38 artigos), reforma estatutária proposta para a AGO de outubro/2026, e análise da ratificação da ATA de 04/10/2024"
fonte_primaria: "F:\\OneDrive\\Projeto A.M.E\\01_Institucional_e_Legal\\ATA E ESTATUTO ATUAL\\PROJETO AME - ESTATUTO - 20240626_181102_OCR.pdf"
status_parecer: "PROVISÓRIO — sujeito a revisão e visto de advogado (RTDPJ)"
---
...
```mermaid
flowchart TD
    R["Requerimento único ao 6º RTDPJ<br/>registro origem nº 173.633"] --> D1["DOC 1 — ATA AGO 26/2024<br/>(reconstituída/ratificada)"]
    R --> D2["DOC 2 — ATA AGO OUT/2026<br/>(ratificação + atos novos)"]
    R --> D3["DOC 3 — Estatuto consolidado<br/>(texto único, com art. 15 §1º + reforma 2026)"]
    R --> D4["DOC 4 — Editais de convocação<br/>(2026 e, se localizado, 2024)"]
    R --> D5["DOC 5 — Listas de presença<br/>(2024 e 2026)"]
    R --> D6["DOC 6 — Visto de advogado<br/>(OAB/SP) em ambas as atas"]
    D1 --> AV["Averbação única<br/>cadeia de mandatos íntegra"]
    D2 --> AV
```
...
```mermaid
flowchart LR
    E25["Publicar edital<br/>até 25/09 (sex)"] --> A03["AGO<br/>03/10/2026 (sáb)"]
    A03 --> P17["Fim do mandato<br/>17-18/10/2026"]
    A03 --> AV["Averbação RTDPJ<br/>até 02/11 (30 dias)"]
```
