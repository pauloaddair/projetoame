...
<!--	<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	...
	<!-- HTML Meta Tags -->
	<title>A.B.I.A.T. — <?php echo isset($titulo) ? htmlspecialchars($titulo) : 'Bem-vindo'; ?></title>
	<meta name="description" content="Associação Brasileira de Inclusão Através do Trabalho - A.M.E. - Atendentes Muito Especiais.">

	<!-- Facebook Meta Tags -->
	<meta property="og:site_name" content="Próximas Atividades do A.M.E."/>
	...
	<meta property="og:image" content="<?php echo $GLOBALS['app_web_root']; ?>img/ame2023.jpg">
	...
	<meta name="twitter:image" content="<?php echo $GLOBALS['app_web_root']; ?>img/ame2023.jpg">
