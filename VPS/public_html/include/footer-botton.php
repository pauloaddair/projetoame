...
<footer class="page-footer text-center font-small primary-color-dark darken-2 mt-5 wow fadeIn fixed-bottom">
    ...
    <!-- Social icons -->
    <div class="pb-1">
      <a href="https://www.facebook.com/atendentesmuitoespeciais" target="_blank">
