...
<div class="container">
      ...
      <a class="navbar-brand" href="../">
		 <img src="/img/android-icon-36x36.png" height="32" class="rounded-pill" ><strong class="text-success">A</strong>tendentes <strong class="text-warning">M</strong>uito <strong class="text-danger">E</strong>speciais
      </a>
...
<div class="dropdown">
  <li class="nav-item avatar dropdown-toggle border border-gray rounded white-text p-2" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
	  <img id = "fotouser" src="/<?php echo $foto?>" class="rounded-circle z-depth-0 "
...
-->
	<div id="div-login" style="display: <?php echo $login?>">
		...
		<a class="dropdown-item mx-2" href="/login"><i class="fas fa-sign-in-alt light-blue-text mx-2"></i>Login</a>
		<a class="dropdown-item mx-2" href="/cadastro" role="button"><i class="fas fa-table light-blue-text mx-2"></i>Cadastre-se</a>
		<a class="dropdown-item mx-2" href="/privacidade" role="button"><i class="fas fa-user-secret light-blue-text mx-2"></i>Política de privacidade</a>
	</div>
	<div id="div-logado" style="display: <?php echo $logado?>">		
		<a class="dropdown-item" href="/perfil"><i class="fas fa-user-alt light-blue-text mx-2"></i>&nbsp;Perfil</a>
		<a class="dropdown-item" href="/admin"><i class="fas fa-columns light-blue-text mx-2"></i>Painel</a>
		<hr class="dropdown-divider" />
		<a class="dropdown-item" href="/logout"><i class="fas fa-sign-out-alt light-blue-text"></i>&nbsp;Sair</a>
	</div>
  </div>
</div>
