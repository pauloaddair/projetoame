...
//              echo $ref . "<br>";
			  ?>
            <form action="<?php echo $GLOBALS['app_web_root']; ?>include/valida.php" method="post">
...
-->
              ...
              <div class="social-login">
				  <a href="<?php echo $GLOBALS['app_web_root']; ?>cadastro" class="d-flex justify-content-center align-items-center rounded-pill text-primary">Cadastre-se</a>
			  </div>
				<!--              
				  <div class="social-login">
    ...
    <script src="<?php echo $GLOBALS['app_web_root']; ?>js/popper.min.js"></script>
    <script src="<?php echo $GLOBALS['app_web_root']; ?>js/bootstrap.min.js"></script>
    <script src="<?php echo $GLOBALS['app_web_root']; ?>js/main.js"></script>
  </body>
</html>
