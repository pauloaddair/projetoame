...
//	echo $query . "<br>";
	...
	If (mysqli_num_rows($r)>0){
		...
		if ($cadastrar==1){
			...
			$query = "INSERT INTO usuarios (`nome`, `login`, `email`, `telefone`, `sobrenome`, `nivel`) VALUES ('".$temp[0]."','".$login."','".$email."','".$telefone."','".$sobrenome."',1)";
/*
			echo $query."<br>";
			exit;
*/
...
<body>
	<div class="container">
		<header>
		<h1 class="text-center"><? echo $msg?></h1>
						...
						<div class="md-form">
							...
							switch ($item[3]){
								case "textarea":
									?>
							<p><? echo $item[0]?></p>
<!--								<label for="<? echo $item[0]?>"><? echo $item[1]?></label>-->
							<textarea class="form-control" id="<? echo $item[0]?>" name="<? echo $item[0]?>"><? echo $dados[$item[0]]?></textarea>
									<?
										break;
								case "option":
									?>
							<p><? echo $item[0]?></p>
<!--								<label for="<? echo $item[0]?>"><? echo $item[1]?></label>-->
<!--								<i class="<? echo $item[4]?> prefix grey-text"></i>-->
								<select class="form-select" id="<? echo $item[0]?>" name="<? echo $item[0]?>">
									<option value="<? echo $item[6]?>"><? echo $item[6]?></option>
									<option value="<? echo $item[7]?>"><? echo $item[7]?></option>
								</select>
							<?
										break;
								case "file":
									?>
								<i class="<? echo $item[4]?> prefix grey-text"></i>
								<input class="form-control"  type="<? echo $item[3]?>" id="<? echo $item[0]?>" name="<? echo $item[0]?>" class="form-control" <? echo $item[5]?>>
							<?
										break;
								default:
									?>
								<i class="<? echo $item[4]?> prefix grey-text"></i>
								<label for="<? echo $item[0]?>"><? echo $item[1]?></label>
								<input type="<? echo $item[3]?>" id="<? echo $item[0]?>" name="<? echo $item[0]?>" class="form-control" placeholder="<? echo $item[2]?>" <? echo $item[5]?> value="<? echo $dados[$item[0]]?>">
							<?
							}
							?>
						</div>
