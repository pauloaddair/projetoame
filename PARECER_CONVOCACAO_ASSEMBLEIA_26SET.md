...
relacionados:
  ...
  - "[[REGRAS_DE_NEGOCIO]]"
criado: "2026-09-09"
assunto: "Convocação da Assembleia Geral de 26/09/2026 — prazos, forma, quórum e pendências documentais"
---
...
```mermaid
flowchart LR
    H["Hoje<br/>09/09 (qua)"] --> P15["Se adotar 15 dias (prudência)<br/>publicar até 11/09 (sex)"]
    H --> P7["Prazo do estatuto (7 dias)<br/>publicar até 19/09 (sáb)"]
    P15 --> A["Assembleia<br/>26/09/2026"]
    P7 --> A
    A --> AV["Averbação no 6º RTDPJ<br/>(+30 dias) e atualização CNPJ/DBE"]
```
